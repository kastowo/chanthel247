...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        _drawLink: function (linkId) {
            ...
            group.setAttribute('class', 'flowchart-link '+String(linkId)); //EDITED BY FLY
            group.setAttribute('id', linkId); //data-link_
            ...
            shape_path.setAttribute("class", 'links-stroke '+String(linkId));
