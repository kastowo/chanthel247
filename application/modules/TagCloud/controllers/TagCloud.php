...
class TagCloud extends MX_Controller {
...
*/
    function index()
    {
	    ...
	    $this->template->write_view('content', 'tagcloud_view', $data, TRUE);
        ...
        function data_1()
        {
            ...
            curl_setopt_array($curl, array(
              // CURLOPT_URL => "http://192.168.1.228/chanthelAPI/index.php?u=".$user."&p=".$pass."&act=grafik1",
        ...
        function data_2()
        {
            ...
            curl_setopt_array($curl, array(
              // CURLOPT_URL => "http://192.168.1.228/chanthelAPI/index.php?u=".$user."&p=".$pass."&act=grafik2",
        ...
        function data_3()
        {
            ...
            curl_setopt_array($curl, array(
              // CURLOPT_URL => "http://192.168.1.228/chanthelAPI/index.php?u=".$user."&p=".$pass."&act=grafik3",
        ...
        function data_4()
        {
            ...
            curl_setopt_array($curl, array(
              // CURLOPT_URL => "http://192.168.1.228/chanthelAPI/index.php?u=".$user."&p=".$pass."&act=grafik4",
