...
<body onload="init()">
  <div class="row">
    <div class="col-12" style="height:80px;padding-left: 80px;">
      <div class="col-6 ">
        <div class="form-group" >
          <div>
            <label for="">Workflow name</label><span class="required" style="  margin-left: 20px">*</span>
            <input class="form-control" type="text" name="workflow_name" id="wf_name" placeholder="Workflow name" value="<?php echo $wf_name;?>" required>
          </div>
        </div>
      </div>
      <div class="col-6 " style="padding:25px;">
        <button type="button" class="button-secondary" id="SaveCButton" style="left:0;" onclick="save_change(<?php echo $wf_id;?>)">Save Change</button>
...
<div id="sample">
  <div style="width: 100%; display: flex; justify-content: space-between">
    <div id="myPaletteDiv" style="width: 100px; height:700px;overflow-y: auto; margin-right: 2px; background-color: #FFFAFA; border: solid 0px black"></div>
