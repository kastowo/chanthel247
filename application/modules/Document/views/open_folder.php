  ...
  <!-- <div class="col-6 no-padding text-right">
    <nav>
      <ul class="content-filter">
        <li><a class="filter-label" style="padding:5px 0 !important">Filter By</a></li>
        <li>
          <select class="select-multiple" name="filetype[]" multiple="multiple">
            <option>Audio</option>
        ...
        <!-- <li>
          <select class="select-multiple-creator" name="creator[]" multiple="multiple">
            <option>Bani</option>
            <option>Danang</option>
            <option>Dhiar</option>
            <option>Dika</option>
            <option>Fatkhul</option>
    ...
    <table id="list-view" class="hover" style="width:100%">
      <thead>
        <tr>
          ...
          <th class="adjust-width sm">Size</th>
          <th class="adjust-width md">Date</th>
          <th></th>
        </tr>
      </thead>
      <tbody>
              ...
              <tr class="star">
                <?php if ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "xlsx" || $v[$i]['ext'] == "xls") ) {?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/xls.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ($v[$i]['template_id'] == 5) { ?>
                  <td onclick="openFolder('<?php echo $v[$i]['id']; ?>')" class="clickable">
                    <img onclick="openFolder('<?php echo $v[$i]['id']; ?>')" src="<?php echo base_url(); ?>/assets/SVG_dark/blue_folder.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo $v[$i]['name']; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "pdf") ) { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/pdf.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "doc" || $v[$i]['ext'] == "docx" || $v[$i]['ext'] == "odt") ) { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/doc.svg" alt=""width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "ppt" || $v[$i]['ext'] == "pptx") ) {?>
                  <td onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/file-ppt.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "mp4" || $v[$i]['ext'] == "avi" || $v[$i]['ext'] == "mov" || $v[$i]['ext'] == "mpeg" || $v[$i]['ext'] == "3gp" || $v[$i]['ext'] == "flv" || $v[$i]['ext'] == "swf") ) { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/file-video.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "jpg" || $v[$i]['ext'] == "png" || $v[$i]['ext'] == "gif" || $v[$i]['ext'] == "bmp" || $v[$i]['ext'] == "tiff") ) { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/file-image.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "zip" || $v[$i]['ext'] == "rar" || $v[$i]['ext'] == "tar.gz") ) { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/archieved.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } elseif ( ($v[$i]['template_id'] == 6) && ($v[$i]['ext'] == "mp3" || $v[$i]['ext'] == "flac" )) { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')"  class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/file-audio.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } else { ?>
                  <td  onclick="previewclick('<?php echo $v[$i]['id']; ?>','<?php echo $v[$i]['ext']; ?>','<?php echo $v[$i]['name']; ?>')" class="clickable">
                    <img src="<?php echo base_url(); ?>/assets/SVG_dark/file-txt.svg" alt="" width="30px" height="30px" style="margin-right:20px; float: left">
                    <p><?php echo substr($v[$i]['name'],0,15).'...'; ?></p>
                  </td>
                <?php } ?>
                  ...
                  <td class="morevert" >
                    ...
                    <div class="option-container" id="menuOption<?php echo $i; ?>">
                      <ul>
                        ...
                        <li><a href="<?php echo $ip; ?>/<?php echo $api; ?>/index.php?u=<?php echo $user; ?>&p=<?php echo $pass; ?>&act=download&fid=<?php echo $v[$i]['id']; ?>" download="<?php echo $v[$i]['name']; ?>">Download</a></li>
                        <li onclick="shareContent()">Share</li>
                        <li>Copy</li>
                        <li>Paste</li>
                        <li onclick="renameContent('<?php echo $v[$i]['id']; ?>', 'file', '<?php echo $v[$i]['name']; ?>')"><a href="#" id="rename">Rename</a></li>
                        <li onclick="deleteclick()">Delete</li>
                        <li>Version History</li>
                      </ul>
                    </div>
...
<script type="text/javascript">
  ...
  // For preview content
   function previewclick(id, ext, name) {
             ...
             if ($('.preview-container').hasClass('shown'))
             {
                $("#downloadprev").attr("href", '<?php echo $ip; ?>/<?php echo $api; ?>/index.php?u=<?php echo $user; ?>&p=<?php echo $pass; ?>&act=download&fid='+id);
                 ...
                 $(".option-container").removeClass("shown");
                  if(ext == "mp4") {
                    $("#reader-content").html("<video width='100%' id='video' height='auto' controls ><source src="+data+" type='video/mp4'></video>");
    ...
    // For get link when sharing content
    function getlink() {
      var dates = new Date($('#date-expiration').val());
      var dataEnd = dates.getTime() / 1000;

      var linkup = "<?php echo $ip; ?>/<?php echo $api; ?>/index.php?u=" + $user + "&p=" + $pass + "&act=share_up&fid=" + $id + "&endtime=" + dataEnd;
